...
const Login = () => {
  ...
  return (
    <div >
      ...
      <form className='absolute rounded-sm bg-gray-950/75 w-3/12 p-12 mx-auto my-36 right-0 left-0 '>
        ...
        <input type="text" placeholder='Email address' className='p-3 my-4 w-full text-[#fef9fd] bg-[#1c1313] rounded-sm'/>
        <input type="password" placeholder='password' className='p-3 my-4 w-full text-[#fef9fd] bg-[#1c1313] rounded-sm'/>
        <button className='bg-[#e50914] text-[#fef9fd] p-3  my-5 w-full rounded-sm'>{isSignInForm ? "Sign Up":"Sign In"}</button>
